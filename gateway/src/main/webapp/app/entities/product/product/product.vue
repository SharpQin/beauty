  ...
  <div>
      ...
      <table class="table table-striped" aria-describedby="products">
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('type')">
              <span v-text="$t('gatewayApp.productProduct.type')">Type</span>
            ...
            <th scope="row" v-on:click="changeOrder('image')">
              <span v-text="$t('gatewayApp.productProduct.image')">Image</span>
            ...
            <th scope="row" v-on:click="changeOrder('releaseDate')">
              <span v-text="$t('gatewayApp.productProduct.releaseDate')">Release Date</span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'releaseDate'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('liveTime')">
              <span v-text="$t('gatewayApp.productProduct.liveTime')">Live Time</span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'liveTime'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('createdTime')">
              <span v-text="$t('gatewayApp.productProduct.createdTime')">Created Time</span>
            ...
            <th scope="row" v-on:click="changeOrder('updatedTime')">
              <span v-text="$t('gatewayApp.productProduct.updatedTime')">Updated Time</span>
            ...
            <th scope="row" v-on:click="changeOrder('stock')">
              <span v-text="$t('gatewayApp.productProduct.stock')">Stock</span>
            ...
            <th scope="row" v-on:click="changeOrder('showed')">
              <span v-text="$t('gatewayApp.productProduct.showed')">Showed</span>
            ...
            <th scope="row" v-on:click="changeOrder('dsc')">
              <span v-text="$t('gatewayApp.productProduct.dsc')">Dsc</span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'dsc'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('category.name')">
              <span v-text="$t('gatewayApp.productProduct.category')">Category</span>
        ...
        <tbody>
          <tr v-for="product in products" :key="product.id" data-cy="entityTable">
            ...
            <td>{{ product.name }}</td>
            <td>{{ product.price }}</td>
            <td v-text="$t('gatewayApp.ProductType.' + product.type)">{{ product.type }}</td>
            <td>{{ product.image }}</td>
            <td>{{ product.releaseDate }}</td>
            <td>{{ product.liveTime ? $d(Date.parse(product.liveTime), 'short') : '' }}</td>
            <td>{{ product.createdTime ? $d(Date.parse(product.createdTime), 'short') : '' }}</td>
            <td>{{ product.updatedTime ? $d(Date.parse(product.updatedTime), 'short') : '' }}</td>
            <td>{{ product.stock }}</td>
            <td>{{ product.showed }}</td>
            <td v-text="$t('gatewayApp.ProductStatus.' + product.status)">{{ product.status }}</td>
            <td>{{ product.dsc }}</td>
            <td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      ...
      <div class="modal-body">
        <p id="au-delete-product-heading" v-text="$t('gatewayApp.productProduct.delete.question', { id: removeId })">
