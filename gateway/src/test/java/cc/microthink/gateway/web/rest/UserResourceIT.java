...
import cc.microthink.gateway.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    public static void deleteEntities(EntityManager em) {
        try {
            em.deleteAll("au_user_authority").block();
