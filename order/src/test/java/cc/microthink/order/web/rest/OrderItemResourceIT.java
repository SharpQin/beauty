...
import cc.microthink.order.repository.OrderItemRepository;
...
class OrderItemResourceIT {
    ...
    void createOrderItem() throws Exception {
        ...
        assertThat(testOrderItem.getProdId()).isEqualTo(DEFAULT_PROD_ID);
    ...
    void putNewOrderItem() throws Exception {
        ...
        OrderItem testOrderItem = orderItemList.get(orderItemList.size() - 1);
        assertThat(testOrderItem.getProdId()).isEqualTo(UPDATED_PROD_ID);
    ...
    void partialUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.prodId(UPDATED_PROD_ID).totalPrice(UPDATED_TOTAL_PRICE).price(UPDATED_PRICE).status(UPDATED_STATUS);
