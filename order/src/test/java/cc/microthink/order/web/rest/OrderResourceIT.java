package cc.microthink.order.web.rest;

import static cc.microthink.order.web.rest.TestUtil.sameNumber;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import cc.microthink.order.IntegrationTest;
...
class OrderResourceIT {
    ...
    private static final UUID DEFAULT_SERIAL_NO = UUID.randomUUID();
    private static final UUID UPDATED_SERIAL_NO = UUID.randomUUID();
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getSerialNo()).isEqualTo(DEFAULT_SERIAL_NO);
        ...
        assertThat(testOrder.getActionTime()).isEqualTo(DEFAULT_ACTION_TIME);
    ...
    void putNewOrder() throws Exception {
        ...
        Order testOrder = orderList.get(orderList.size() - 1);
        assertThat(testOrder.getSerialNo()).isEqualTo(UPDATED_SERIAL_NO);
        ...
        assertThat(testOrder.getActionTime()).isEqualTo(UPDATED_ACTION_TIME);
