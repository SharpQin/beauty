...
import cc.microthink.order.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link cc.microthink.order.domain.OrderItem}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<OrderItem> partialUpdateOrderItem(
        ...
        Optional<OrderItem> result = orderItemRepository
            ...
            .map(existingOrderItem -> {
                if (orderItem.getProdId() != null) {
                    existingOrderItem.setProdId(orderItem.getProdId());
                }
