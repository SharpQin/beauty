package cc.microthink.payment.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import cc.microthink.payment.IntegrationTest;
import cc.microthink.payment.repository.timezone.DateTimeWrapper;
import cc.microthink.payment.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM pm_date_time_wrapper where id=%d", fieldName, id);
    }
