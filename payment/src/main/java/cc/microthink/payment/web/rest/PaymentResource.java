...
import cc.microthink.payment.service.PaymentService;
import cc.microthink.payment.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link cc.microthink.payment.domain.Payment}.
 */
@RestController
@RequestMapping("/api")
