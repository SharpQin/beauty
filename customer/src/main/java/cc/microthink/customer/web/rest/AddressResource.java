...
/**
 * REST controller for managing {@link cc.microthink.customer.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Address> partialUpdateAddress(
        ...
        Optional<Address> result = addressRepository
            ...
            .map(existingAddress -> {
                ...
                if (address.getDefaultAddr() != null) {
                    existingAddress.setDefaultAddr(address.getDefaultAddr());
                }
