...
import cc.microthink.customer.domain.Address;
import cc.microthink.customer.repository.AddressRepository;
...
class AddressResourceIT {
    ...
    private static final Boolean DEFAULT_DEFAULT_ADDR = false;
    private static final Boolean UPDATED_DEFAULT_ADDR = true;
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address()
            ...
            .defaultAddr(DEFAULT_DEFAULT_ADDR);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address()
            ...
            .defaultAddr(UPDATED_DEFAULT_ADDR);
        return address;
    }
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getDefaultAddr()).isEqualTo(DEFAULT_DEFAULT_ADDR);
    }
    ...
    void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.[*].defaultAddr").value(hasItem(DEFAULT_DEFAULT_ADDR.booleanValue())));
    }
    ...
    void getAddress() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.defaultAddr").value(DEFAULT_DEFAULT_ADDR.booleanValue()));
    }
    ...
    void putNewAddress() throws Exception {
        ...
        updatedAddress.postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY).details(UPDATED_DETAILS).defaultAddr(UPDATED_DEFAULT_ADDR);
        ...
        assertThat(testAddress.getDefaultAddr()).isEqualTo(UPDATED_DEFAULT_ADDR);
    }
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.city(UPDATED_CITY).details(UPDATED_DETAILS).defaultAddr(UPDATED_DEFAULT_ADDR);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY).details(UPDATED_DETAILS).defaultAddr(UPDATED_DEFAULT_ADDR);
