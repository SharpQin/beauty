package cc.microthink.notification.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import cc.microthink.notification.IntegrationTest;
import cc.microthink.notification.repository.timezone.DateTimeWrapper;
import cc.microthink.notification.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM nf_date_time_wrapper where id=%d", fieldName, id);
    }
