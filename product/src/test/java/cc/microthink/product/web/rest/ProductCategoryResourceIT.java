...
import cc.microthink.product.domain.ProductCategory;
import cc.microthink.product.repository.ProductCategoryRepository;
...
class ProductCategoryResourceIT {
    ...
    public static ProductCategory createEntity(EntityManager em) {
        ProductCategory productCategory = new ProductCategory().name(DEFAULT_NAME).dsc(DEFAULT_DSC);
    ...
    public static ProductCategory createUpdatedEntity(EntityManager em) {
        ProductCategory productCategory = new ProductCategory().name(UPDATED_NAME).dsc(UPDATED_DSC);
        return productCategory;
    }
    ...
    void createProductCategory() throws Exception {
        ...
        assertThat(testProductCategory.getDsc()).isEqualTo(DEFAULT_DSC);
    }
    ...
    void putNewProductCategory() throws Exception {
        ...
        updatedProductCategory.name(UPDATED_NAME).dsc(UPDATED_DSC);
        ...
        assertThat(testProductCategory.getDsc()).isEqualTo(UPDATED_DSC);
    }
    ...
    void fullUpdateProductCategoryWithPatch() throws Exception {
        ...
        partialUpdatedProductCategory.name(UPDATED_NAME).dsc(UPDATED_DSC);
