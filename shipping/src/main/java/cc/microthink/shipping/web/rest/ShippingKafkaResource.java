...
@RestController
@RequestMapping("/api/shipping-kafka")
public class ShippingKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ShippingKafkaResource.class);
    ...
    public ShippingKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
