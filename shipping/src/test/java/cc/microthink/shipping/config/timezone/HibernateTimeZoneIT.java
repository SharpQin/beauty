package cc.microthink.shipping.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import cc.microthink.shipping.IntegrationTest;
import cc.microthink.shipping.repository.timezone.DateTimeWrapper;
import cc.microthink.shipping.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM sh_date_time_wrapper where id=%d", fieldName, id);
    }
